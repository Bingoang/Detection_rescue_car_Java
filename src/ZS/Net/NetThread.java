...
public class NetThread extends Thread{
	public static final  String IP ="192.168.8.1";//若是本机IP则为："127.0.0.1 "
	private String str;
	...
	public void run() {
		try {
			Socket socket = new Socket(IP,2001);//这个端口要改吗？
...
//					}
					...
					{
						mainFrm.carmeraTherad=new CarmeraTherad(mainFrm);
	...
	public NetThread(MainFrm mainFrm) 
	{
